...
export class MyApp {
  ...
  constructor(platform: Platform) {
    /*
     ...
     db.executeSql("INSERT INTO user(id, user_name, password) VALUES ('1','monia','monia')", []).then((data) => {
     ...
     db.executeSql("INSERT INTO grupa(id, group_name, built_in, id_user ) VALUES ('3','Kolory','0', '1')", []).then((data) => {
     console.log("INSERTED: " + JSON.stringify(data));
     ...
     db.executeSql("INSERT INTO word_en(id, word_en_name, sentence_en ) VALUES ('1','red','I like red')", []).then((data) => {
     console.log("INSERTED: " + JSON.stringify(data));
     ...
     db.executeSql("INSERT INTO word_pl(id, word_pl_name, sentence_pl ) VALUES ('1','czerwony','Uwielbiam czerwony kolor')", []).then((data) => {
     console.log("INSERTED: " + JSON.stringify(data));
     ...
     db.executeSql("INSERT INTO word_en(id, word_en_name, sentence_en ) VALUES ('2','green','I like green')", []).then((data) => {
     console.log("INSERTED: " + JSON.stringify(data));
     ...
     db.executeSql("INSERT INTO word_pl(id, word_pl_name, sentence_pl ) VALUES ('2','zielony','Uwielbiam czerwony zielony')", []).then((data) => {
     console.log("INSERTED: " + JSON.stringify(data));
     ...
     db.executeSql("INSERT INTO translation(id, id_word_en, id_word_pl ) VALUES ('1','1','1')", []).then((data) => {
     console.log("INSERTED: " + JSON.stringify(data));
     ...
     db.executeSql("INSERT INTO translation(id, id_word_en, id_word_pl ) VALUES ('2','2','2')", []).then((data) => {
     console.log("INSERTED: " + JSON.stringify(data));
     ...
     db.executeSql("INSERT INTO group_translation(id_word_en, id_word_pl ) VALUES ('1','1')", []).then((data) => {
     console.log("INSERTED: " + JSON.stringify(data));
     ...
     db.executeSql("INSERT INTO group_translation(id_word_en, id_word_pl ) VALUES ('1','2')", []).then((data) => {
     console.log("INSERTED: " + JSON.stringify(data));
     ...
     db.executeSql("INSERT INTO grupa(id_group, id_translation ) VALUES ('3', '1')", []).then((data) => {
     console.log("INSERTED: " + JSON.stringify(data));
